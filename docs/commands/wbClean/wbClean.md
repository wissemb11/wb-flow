---
title: "wbClean — Remove dead code and stale artifacts"
description: "Scans a package for unused exports, orphan files, stale reports, and dead workflow state. Produces a cleanup plan or executes it directly."
---
