...
1. **[`installation`](installation.md)** — **Step 0**: How to get the framework into your project (NPM, NPX, or Git clone). Read this before anything else.
...
| You are... | Read |
|---|---|
| Need to install the framework | [`installation`](installation.md) |
| Brand-new to the workflow | [`getting_started`](getting_started.md) |
...
- Not a concept primer. For *why* the system works, go to [`../concepts/`](../concepts/README.md).
